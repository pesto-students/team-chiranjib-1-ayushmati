...
import ReceptionistDashboardTest from "./component/dashboard/reception/reception-dashboard-1";
...
function App() {
  ...
  <Router>
    <Routes>
      ...
      <Route path="/receptionistDashboard" element = {<ReceptionistDashboardTest/>}/>
