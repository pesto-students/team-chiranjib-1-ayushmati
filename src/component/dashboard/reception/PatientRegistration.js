...
import { genderList, maritalStatusList, stateList, countryList, townCityList, bloodGrpList } from "../../master/MasterList";
...
function PatientRegistration() {
  ...
  useEffect(() => {
    ...
    if(id != 0 && id != '') {
      axios.get(`http://localhost:8080/patientRegistration/getPatient/${id}`)
      .then(res => {
    ...
    const getPrimaryDoctorList = async () => {
      try {
        const response = await axios.get('http://localhost:8080/user/listActiveDoctor'); // Replace with your API endpoint
    ...
    const getDiseaseList = async () => {
      try {
        const response = await axios.get('http://localhost:8080/disease/listDisease'); // Replace with your API endpoint
        console.log(response.data);
  ...
  */
  ...
  function handleSubmit(event) {
    ...
    try {
      if(patientID === ''){
        axios.post(`http://localhost:8080/patientRegistration/createPatient`, { newPatient:newPatient })
        .then(res => {
          if (res.status === 201) {
          ...
          axios.put(`http://localhost:8080/patientRegistration/updatePatient/${patientID}`, { newPatient:newPatient })
          .then(res => {
